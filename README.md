...
**2.Book rooms by type (Standard, Deluxe, Suite)**
...
**2.File I/O with serialization (.dat files)**
...
**1.Choose options from the menu (view, book, cancel, show bookings, exit)**

**2.Enter name and room type when booking**
...
**1.GUI using Swing/JavaFX**

**2.Room pricing based on type/duration**

**3.User authentication for staff/customers**

**4.Real payment integration**

**5.Booking reports and statistics**
